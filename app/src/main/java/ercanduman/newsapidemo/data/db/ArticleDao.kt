 ...
 *   It solved most of the existing problems. But when there are any future changes in the database LiveData is helpless in this situation.
 *   After a while, the room used Kotlin flow to solve this problem.
 ...
 *
 * As a result, Flow will be used for interactions with Room library, and LiveData (which is lifecycle aware)
 * will be used inside ViewModel and UI related components for observing data changes.
 *
 * @author ercan
 * @since  3/1/21
 */
